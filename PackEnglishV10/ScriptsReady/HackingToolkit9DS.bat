...
echo.
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -xtf 3ds %Rom3DS%.3ds --header HeaderNCCH.bin -0 DecryptedPartition0.bin -1 DecryptedPartition1.bin -2 DecryptedPartition2.bin -6 DecryptedPartition6.bin -7 DecryptedPartition7.bin >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -xtf cxi DecryptedPartition0.bin --header HeaderNCCH0.bin --exh DecryptedExHeader.bin --exh-auto-key --exefs DecryptedExeFS.bin --exefs-auto-key --romfs DecryptedRomFS.bin --romfs-auto-key --logo LogoLZ.bin --plain PlainRGN.bin >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -xtf cfa DecryptedPartition1.bin --header HeaderNCCH1.bin --romfs DecryptedManual.bin --romfs-auto-key >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -xtf cfa DecryptedPartition2.bin --header HeaderNCCH2.bin --romfs DecryptedDownloadPlay.bin --romfs-auto-key >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -xtf cfa DecryptedPartition6.bin --header HeaderNCCH6.bin --romfs DecryptedN3DSUpdate.bin --romfs-auto-key >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -xtf cfa DecryptedPartition7.bin --header HeaderNCCH7.bin --romfs DecryptedO3DSUpdate.bin --romfs-auto-key >NUL 2>NUL
...
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -xtf romfs DecryptedRomFS.bin --romfs-dir ExtractedRomFS >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -xtf romfs DecryptedManual.bin --romfs-dir ExtractedManual >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -xtf romfs DecryptedDownloadPlay.bin --romfs-dir ExtractedDownloadPlay >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -xtf romfs DecryptedN3DSUpdate.bin --romfs-dir ExtractedN3DSUpdate >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -xtf romfs DecryptedO3DSUpdate.bin --romfs-dir ExtractedO3DSUpdate >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -%ScriptCode% exefs DecryptedExeFS.bin --exefs-dir ExtractedExeFS --header HeaderExeFS.bin >NUL 2>NUL
...
echo.
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf romfs CustomRomFS.bin --romfs-dir ExtractedRomFS >NUL 2>NUL
ren ExtractedExeFS\banner.bin banner.bnr >NUL 2>NUL
ren ExtractedExeFS\icon.bin icon.icn >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf exefs CustomExeFS.bin --exefs-dir ExtractedExeFS --header HeaderExeFS.bin >NUL 2>NUL
ren ExtractedExeFS\banner.bnr banner.bin >NUL 2>NUL
ren ExtractedExeFS\icon.icn icon.bin >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf romfs CustomManual.bin --romfs-dir ExtractedManual >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf romfs CustomDownloadPlay.bin --romfs-dir ExtractedDownloadPlay >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf romfs CustomN3DSUpdate.bin --romfs-dir ExtractedN3DSUpdate >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf romfs CustomO3DSUpdate.bin --romfs-dir ExtractedO3DSUpdate >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf cxi CustomPartition0.bin --header HeaderNCCH0.bin --exh DecryptedExHeader.bin --exefs CustomExeFS.bin --romfs CustomRomFS.bin --logo LogoLZ.bin --plain PlainRGN.bin >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf cfa CustomPartition1.bin --header HeaderNCCH1.bin --romfs CustomManual.bin >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf cfa CustomPartition2.bin --header HeaderNCCH2.bin --romfs CustomDownloadPlay.bin >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf cfa CustomPartition6.bin --header HeaderNCCH6.bin --romfs CustomN3DSUpdate.bin >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf cfa CustomPartition7.bin --header HeaderNCCH7.bin --romfs CustomO3DSUpdate.bin >NUL 2>NUL
for %%j in (Custom*.bin) do if %%~zj LEQ 20000 del %%j >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf 3ds %OutputRom3DS%_Edited.3ds --header HeaderNCCH.bin -0 CustomPartition0.bin -1 CustomPartition1.bin -2 CustomPartition2.bin -6 CustomPartition6.bin -7 CustomPartition7.bin >NUL 2>NUL
echo Creation done!
echo.
pause
goto:TitleMenu
...
"%PROGRAMFILES%\HackingToolkit9DS\makerom.exe" -f cia %ARG0% %ARG1% %ARG2% -minor %MinorVer% -micro %MicroVer% -o %OutputRomCIA%_Edited.cia >NUL 2>NUL
echo Creation done!
echo.
pause
goto:TitleMenu
...
echo Please wait, extraction in progress...
echo.
"%PROGRAMFILES%\HackingToolkit9DS\ctrtool.exe" -p --ncch=0 --exheader=DecryptedExHeader.bin %RomCXI%.cxi >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\ctrtool.exe" -p --ncch=0 --exefs=DecryptedExeFS.bin %RomCXI%.cxi >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\ctrtool.exe" -p --ncch=0 --romfs=DecryptedRomFS.bin %RomCXI%.cxi >NUL 2>NUL
...
cls
echo.
for %%x in (*.3ds *.app *.cci) DO CALL "%PROGRAMFILES%\HackingToolkit9DS\Unpack3DSYes.bat" "%%x"
for %%x in (*.cia) DO GOTO UnpackCIAMenu
goto:TitleMenu
...
cls
echo.
for %%x in (*.3ds *.app *.cci) DO CALL "%PROGRAMFILES%\HackingToolkit9DS\Unpack3DSNo.bat" "%%x"
for %%x in (*.cia) DO GOTO UnpackCIAMenu
goto:TitleMenu
...
cls
echo.
for %%x in (*.3ds *.app *.cci) DO CALL "%PROGRAMFILES%\HackingToolkit9DS\Unpack3DSAsk.bat" "%%x"
for %%x in (*.cia) DO GOTO UnpackCIAMenu
goto:TitleMenu
...
cls
echo.
for %%x in (*.cia) DO CALL "%PROGRAMFILES%\HackingToolkit9DS\UnpackCIAYes.bat" "%%x"
goto:TitleMenu

:UnpackCIANo
cls
echo.
for %%x in (*.cia) DO CALL "%PROGRAMFILES%\HackingToolkit9DS\UnpackCIANo.bat" "%%x"
goto:TitleMenu

:UnpackCIAAsk
cls
echo.
for %%x in (*.cia) DO CALL "%PROGRAMFILES%\HackingToolkit9DS\UnpackCIAAsk.bat" "%%x"
goto:TitleMenu

:MassRebuilder
cls
echo.
for /D %%D in (*.3ds *.app *.cci) DO CALL "%PROGRAMFILES%\HackingToolkit9DS\Repack3DS.bat" "%%~nD"
