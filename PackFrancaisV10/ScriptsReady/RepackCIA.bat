...
echo.
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf romfs %CiaFull%_Unpacked\CustomRomFS.bin --romfs-dir %CiaFull%_Unpacked/ExtractedRomFS >NUL 2>NUL
...
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf exefs %CiaFull%_Unpacked\CustomExeFS.bin --exefs-dir %CiaFull%_Unpacked/ExtractedExeFS --header %CiaFull%_Unpacked/HeaderExeFS.bin >NUL 2>NUL
...
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf romfs %CiaFull%_Unpacked\CustomManual.bin --romfs-dir %CiaFull%_Unpacked/ExtractedManual >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf romfs %CiaFull%_Unpacked\CustomDownloadPlay.bin --romfs-dir %CiaFull%_Unpacked/ExtractedDownloadPlay >NUL 2>NUL
...
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf cfa %CiaFull%_Unpacked\CustomPartition1.bin --header %CiaFull%_Unpacked\HeaderNCCH1.bin --romfs %CiaFull%_Unpacked\CustomManual.bin >NUL 2>NUL
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -ctf cfa %CiaFull%_Unpacked\CustomPartition2.bin --header %CiaFull%_Unpacked\HeaderNCCH2.bin --romfs %CiaFull%_Unpacked\CustomDownloadPlay.bin >NUL 2>NUL
